...
Pathfinder.FEATURES = {
  ...
  'Smite Evil':
    'Section=combat ' +
    'Note="+%V attack, +%1 damage, and +%2 AC vs. evil foe %3/dy"',
  ...
  "Artificer's Touch":
    ...
    'Note="Touch attack on objects and constructs 1d6+%1 HP %V/dy",' +
         '"<i>Mending</i> at will"',
  'Ascension':
    'Section=magic,save ' +
  ...
  'Fleeting Glance':'Section=magic Note="Self invisible %V rd/dy"',
  ...
  'Grave Touch':'Section=magic Note="Touch causes shaken %V rd %1/dy"',
  ...
  'Heavenly Fire':
    'Section=magic ' +
    'Note="R30\' Ranged touch heal good or harm evil 1d4+%V HP %1/dy"',
...
Pathfinder.SPELLS = {
  ...
  'Darkness':'Level=Adept2,B2,C2,W2',
  'Darkvision':'Level=R3,W2',
  'Daylight':'Level=Adept3,B3,C3,D3,P3,W3',
  ...
  'Deeper Darkness':'Level=Adept3,C3,Darkness3',
  ...
  'Levitate':'Level=W2',
  'Light':'Level=Adept0,B0,C0,D0,Rogue0,W0',
  ...
  'Remove Curse':'Level=Adept3,B3,C3,Celestial4,Liberation3,P3,W4',
  'Remove Disease':'Level=Adept3,C3,D3,R3',

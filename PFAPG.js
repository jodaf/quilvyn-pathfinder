...
PFAPG.FEATURES = {
  ...
  'Calling':
    ...
    'Note=' +
      ...
      '"+%1 %V level"',
  'Cavalier Feat Bonus':'Section=feature Note="Gains %V Fighter Feats"',
  "Cavalier's Charge":
    'Section=combat ' +
  ...
  'Greater Tactician':'Section=feature Note="Gains 1 Teamwork feat"',
  "Knight's Challenge":
    'Section=combat ' +
  ...
  'Mounted Mastery':
    ...
    'Note=' +
      ...
      '"Gains 1 Order Of The Sword feat",' +
  ...
  'Ki Weapons':
    'Section=combat ' +
    'Note="May spend 1 Ki Point to inflict %{unarmedDamageDice}+%{unarmedDamageModifier} w/improvised weapon for 1 rd%{levels.Monk>=11 ? \'/May spend up to \' + (levels.Monk>=15 ? 5 : 3) + \' Ki Points to give improvised weapon enhancement bonus or abilities for 1 rd\' : \'\'}"',
  'Learned Master':
    'Section=skill ' +
  ...
  'Mystic Persistence':
    'Section=combat ' +
    'Note="May spend 2+ Ki Points to create 20\' radius that gives allies better of two attack and save rolls for 1 rd + 1 rd per 2 Ki Points spent"',
  'Mystic Prescience':'Section=combat Note="+%V AC/+%V CMD"',
  'Mystic Visions':
    'Section=magic ' +
    'Note="May spend 2 Ki Points to use effects of <i>Divination</i>"',
  ...
  'Touch Of Surrender':
    'Section=magic ' +
    'Note="May spend 6 Ki Points to add <i>Charm Monster</i> effect for %{levels.Monk} dy to damage that reduces foe to 0 or negative HP"',
  ...
  'Deadly Sneak':
    'Section=combat ' +
    'Note="During full-attack action, may suffer -2 attack to treat sneak attack damage 1s and 2s as 3s"',
  ...
  'Fast Getaway':
    'Section=combat ' +
    'Note="May make immediate %{speed}\' withdraw after successful sneak attack or Sleight Of Hand"',
  'Fast Picks':
    'Section=skill ' +
    'Note="May use Disable Device to open lock as a standard action"',
  'Fast Tumble':
    'Section=skill ' +
    'Note="Suffers no Acrobatics penalty to move through threatened square w/out AOO"',
  ...
  "Hunter's Surprise":
    'Section=combat ' +
    'Note="May add sneak attack damage to successful attacks on adjacent foe for 1 rd 1/dy"',
  'Knock-Out Blow':
    'Section=combat ' +
  ...
  'Powerful Sneak':
    'Section=combat ' +
    'Note="During full-attack action, may suffer -2 attack to treat sneak attack damage 1s as 2s"',
  'Quick Disguise':
    'Section=skill ' +
  ...
  'Redirect Attack':
    'Section=combat ' +
    'Note="May redirect successful attack on self to new attack on adjacent creature 1/dy"',
  "Scout's Charge":
    'Section=combat ' +
  ...
  'Stab And Grab':
    'Section=combat ' +
    'Note="Successful attack with sneak attack or before target acts in surprise rd inflicts -5 Perception vs. Sleight Of Hand to steal from target"',
  'Stealthy Sniper':
  ...
  'Trap Master':
    'Section=skill ' +
    'Note="May bypass trap on any successful Disable Device/May change which creatures can safely pass a magical trap"',
  ...
  'Raise The Deep':
    'Section=magic ' +
    'Note="May raise water as per%{levels.Sorcerer>=20 ? \' dbl dimension\' : \'\'} <i>Control Water</i> for %{levels.Sorcerer} rd even when no water present 1/dy"',
  'Reality Wrinkle':
    'Section=combat ' +
  ...
  'Wind Servant':
    'Section=magic ' +
    'Note="May blow %{levels.Wizard} lb object 30\', hit target w/ranged touch %{intelligenceModifier+3}/dy"',
  ...
  'Elemental Focus (Fire)':
    'Section=magic ' +
    'Note="+%V save DC on spells that inflict fire damage; uses +1 spell slot"',
  ...
  'Perfect Strike':
    'Section=combat Note="May use best of %V rolls when attacking w/%1 %2/dy"',
  'Persistent Spell':
    'Section=magic ' +
...
PFAPG.SPELLS = {
  ...
  'Acid Pit':
    ...
    'Description="R%{100+lvl*10}\' Creates 10\'x10\' %{lvl//2*10<?100}\' deep extradimensional pit containing 5\' of acid for %{lvl+1} rd; creatures on top fall in (Ref neg, adjacent squares Ref+2; DC 30 Climb to exit) and suffer 2d6 HP acid/rd; objects suffer broken after 3 rd (Fort delays 1 rd), then destroyed 1 rd later (Fort delays 1 rd)"',
  ...
  'Ball Lightning':
    'School=Evocation ' +
    'Level=D4,S4,W4 ' +
    'Description="R%{100+lvl*10}\' %{(lvl+1)//4} 5\' spheres fly 20\'/rd, inflict 3d6 HP electricity (Ref neg; -4 in metal armor) in same square for %{lvl} rd"',
  'Banish Seeming':
    'School=Abjuration ' +
  ...
  'Blessing Of Fervor':
    'School=Transmutation ' +
    'Level=C4,O4 ' +
    'Description="R%{25+lvl//2*5}\' %{lvl} targets in 15\' radius gain choice each rd from: +30 Speed; stand as swift action w/out provoking AOO; extra attack as part of full-attack action; +2 attack, AC, and Reflex; or use metamagic for free w/spell up to level 2 for %{lvl} rd"',
  ...
  'Break':
    'School=Transmutation ' +
    'Level=S1,W1 ' +
    'Description="R%{25+lvl//2*5}\' Medium object target becomes broken or already-broken object destroyed (Fort neg)"',
  ...
  'Campfire Wall':
    ...
    'Description="R%{25+lvl//2*5}\' 20\' radius around fire blocks sight, inflicts 1d6 HP fire and 1d6 min glow on those passing toward fire for %{lvl*2} hr"',
  'Cast Out':
    'School=Abjuration ' +
    'Level=Inquisitor3 ' +
  ...
  'Confess':
    'School=Enchantment ' +
    'Level=Inquisitor2 ' +
    'Description="R%{25+lvl//2*5}\' Target must answer one self question truthfully or suffer %{lvl//2<?5}d6 HP and 2d4 rd sickened (Will half HP only)"',
  'Contagious Flame':
    'School=Evocation ' +
    'Level=S6,W6 ' +
  ...
  'Foe To Friend':
    'School=Enchantment ' +
    'Level=B5 ' +
    'Description="R%{100+lvl*10}\' Redirects or negates foe attack and self counts foe as ally for flanking for 1 rd (Will neg)"',
  'Follow Aura':
    'School=Divination ' +
    'Level=Inquisitor2 ' +
  ...
  'Forced Repentance':
    ...
    'Description="R%{25+lvl//2*5}\' Evil target creature (not of evil subtype) falls prone and makes confession (Will neg) for %{lvl} rd"',
  'Frozen Note':
    'School=Enchantment ' +
    'Level=B5 ' +
  ...
  'Heroic Finale':
    'School=Enchantment ' +
    'Level=B4 ' +
    'Description="R%{25+lvl//2*5}\' End of Bardic Performance allows target immediate move or standard action"',
  'Hidden Speech':
    'School=Transmutation ' +
  ...
  'Hydraulic Push':
    'School=Evocation ' +
    'Level=D1,S1,W1 ' +
    'Description="R%{25+lvl//2*5}\' Target suffers CMB +%{lvl+(intelligenceModifier>?wisdomModifier>?charismaModifier)} bull rush; extinguishes normal fire up to 5\' sq"',
  'Hydraulic Torrent':
    'School=Evocation ' +
    'Level=D3,S3,W3 ' +
  ...
  'Ill Omen':
    'School=Enchantment ' +
    'Level=Witch1 ' +
    'Description="R%{25+lvl//2*5}\' Target suffers worse of two rolls for next %{lvl//5+1} d20 rolls (aware target can use move action to negate 1) w/in %{lvl} rd"',
  'Innocence':
    'School=Transmutation ' +
    'Level=B1 ' +
  ...
  "Paladin's Sacrifice":
    'School=Abjuration ' +
    'Level=P2 ' +
    'Description="R%{25+lvl//2*5}\' Immediate damage and negative effects to target transferred to self"',
  'Perceive Cues':
    'School=Transmutation ' +
  ...
  'Unwitting Ally':
    'School=Enchantment ' +
    'Level=B0 ' +
    'Description="R%{25+lvl//2*5}\' Self counts target as ally for flanking (Will neg), foes do not, for 1 rd"',
  'Vanish':
    'School=Illusion ' +
    'Level=B1,S1,W1 ' +
  ...
  'Versatile Weapon':
    'School=Transmutation ' +
    'Level=B2,R2,S3,W3 ' +
    'Description="R%{25+lvl//2*5}\' Target weapon bypasses DR of choice of bludgeoning, cold iron, piercing, silver, or slashing for %{lvl} min"',
  'Vomit Swarm':
    'School=Conjuration ' +
  ...
  'Vortex':
    ...
    'Description="R%{400+lvl*40}\' 15\' radius inflicts 3d6 HP bludgeoning (Ref neg) on first contact, then 1d8 HP/rd on Medium and smaller (Ref neg) for %{lvl-1} rd; self may eject creatures from vortex"',
  'Wake Of Light':
    'School=Evocation ' +
    'Level=P2 ' +

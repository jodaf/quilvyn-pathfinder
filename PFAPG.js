...
PFAPG.FEATURES = {
  ...
  "Death's Touch":
    'Section=combat ' +
    'Note="Touch inflicts 1d6+%{mysteryLevel//2} HP negative energy (undead heals and gives +2 channel resistance for 1 min) %{charismaModifier+3}/dy"',
  'Delay Affliction':
    'Section=save ' +
  ...
  'Maneuver Mastery':
    'Section=combat,feature ' +
    'Note=' +
      '"+%{mysteryLevel - mysteryLevel*3//4} on chosen combat maneuver",' +
  ...
  'Soul Siphon':
    'Section=magic ' +
    'Note="R30\' Ranged touch inflicts negative level for %{charismaModifier} min, heals %{mysteryLevel} HP to self %{(mysteryLevel-3)//4}/dy"',
  'Spark Skin':
    'Section=save ' +
  ...
  'Surprising Charge':
    'Section=combat ' +
    'Note="May make immediate move %{mysteryLevel>=15 ? 3 : mysteryLevel>=7 ? 2 : 1}/dy"',
  'Think On It':
...
PFAPG.SPELLS = {
  ...
  'Geyser':
    'School=Conjuration ' +
    'Level=Aquatic4,D4,W5,Waves5,Witch5 ' + // Witch Water
  ...
  'Seamantle':
    'School=Conjuration ' +
    'Level=Aquatic8,D8,W8,Waves8,Witch8 ' + // Witch Water
  ...
  'Slipstream':
    'School=Conjuration ' +
    'Level=Aquatic2,D2,Oceans2,R2,W2,Waves2,Witch2 ' + // Witch Water
  ...
  'Tsunami':
    'School=Conjuration ' +
    'Level=D9,Oceans9,W9,Waves9,Witch9 ' + // Witch Water
  ...
  'Vortex':
    'School=Evocation ' +
    'Level=D7,W7,Waves7,Witch7 ' + // Witch Elements
...
PFAPG.SPELLS_LEVELS_ADDED = {
  ...
  'Charm Animal':'Nature1,Witch1', // Witch Animals
  ...
  'Control Undead':'Bones7,Witch7', // Witch Plague
  ...
  'Greater Restoration':'Life7,O7,Witch7', // Witch Endurance
  ...
  'Magic Vestment':
    'Battle3,Inquisitor3,Martyr3,O3,Resolve3,Tactics3,Witch3', // Witch Wisdom
  ...
  "Mass Bull's Strength":'Battle6,Ferocity6,O6,Witch6', // Witch Strength
  ...
  'Righteous Might':
    'Battle5,Ferocity5,Growth5,Heroism5,Honor5,Inquisitor5,O5,Resolve5,Witch5', // Witch Strength
